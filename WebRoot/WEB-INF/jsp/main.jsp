...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="<%=basePath%>LoginController/main.action">后台管理系统</a></div>
        <div class="left_open">
        ...
        <ul class="layui-nav right" lay-filter="">
          <li class="layui-nav-item">
            <a href="javascript:;">${user.mgname }</a>
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              <dd><a title="个人信息"  onclick="x_admin_show('个人信息','<%=basePath%>LoginController/managerUpdatePage.action',600,400)" href="javascript:;">个人信息</a></dd>
              <dd><a href="<%=basePath%>LoginController/jump.action">切换帐号</a></dd>
              <dd><a href="<%=basePath %>LoginController/jump.action">退出</a></dd>
            </dl>
          </li>
          <li class="layui-nav-item to-index"><a href="<%=basePath%>LoginController/main.action">首页</a></li>
        </ul>

  ...
  <body>
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <a href="<%=basePath%>DressingController/addDressingPage.action?pageNum=${pageNum}"><button class="layui-btn" ><i class="layui-icon"></i>添加</button></a>
      ...
      <table class="layui-table">
        ...
        <tbody>
       			<c:forEach items="${dressingList}" var="dl" varStatus="num">
					<tr>
						<td>
						  <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='${dl.did}'><i class="layui-icon">&#xe605;</i></div>
			            </td>
						...
						<td class="td-manage">
			              <a title="删除" onclick="delOne(${dl.did})" href="javascript:;">
  ...
  //分页
	$("#page").paging({
		...
		callback: function(num) {
			location.href="<%=basePath%>DressingController/findDressing.action?pageNum="+num;
		}
	});
	  function delAll(argument) {
        ...
        location.href="<%=basePath%>DressingController/delectDressing.action?data="+data+"&pageNum="+${pageNum};
      }

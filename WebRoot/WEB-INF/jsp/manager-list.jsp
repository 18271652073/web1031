  ...
  <body>
    ...
    <div class="x-body">
          ...
          <input class="layui-input" placeholder="姓名" name="mgmyname" id="mgmyname">
           <div class="layui-inline">
	         <div class="layui-input-inline">
		        <select name="mgbuildnum" id="mgbuildnum" onchange="javascript:document.forms[0].submit();">
      ...
      <table class="layui-table">
        ...
        <tbody>
       			<c:forEach items="${managerList}" var="ml" varStatus="num">
					<tr>
						<td>
						  <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='${ml.mgid}'><i class="layui-icon">&#xe605;</i></div>
			            </td>
						...
						<c:if test="${user.mgpower==3 }">
							 <a title="编辑" href="<%=basePath%>ManagerController/editManagerPage.action?mgid=${ml.mgid }&pageNum=${pageNum}">
						...
						<c:if test="${user.mgpower<=2 }">
			              ...
			              <a title="删除" onclick="delOne(${ml.mgid})" href="javascript:;">
			                <i class="layui-icon">&#xe640;</i>
			              </a>
			            </td>
					</tr>
  ...
  //分页
	$("#page").paging({
		...
		callback: function(num) {
			location.href="<%=basePath%>ManagerController/findManager.action?pageNum="+num;
		}
	});
	  function delAll(argument) {
        ...
        location.href="<%=basePath%>ManagerController/delectManager.action?data="+data+"&pageNum="+${pageNum};
      }
	  ...
	  function add(){
			 ...
			 location.href="<%=basePath%>ManagerController/addManagerPage.action?pageNum=${pageNum}";
		}
	  function turn() {
		  alert("1");

...
<html>
  ...
  <div class="x-nav">
    ...
    <div class="x-body">
        <form class="layui-form" method="post" action="<%=basePath%>ManagerController/addManager.action">
        <input type="hidden" name="pageNum" value="${pageNum}" />
          ...
          <input type="password" name="mgpassword" style="display: none;" disabled autocomplete = "off"/>
          <div class="layui-form-item">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="password" id="rmgpassword" name="rmgpassword"  required="" lay-verify="repass" value="${stumanager.mgpassword }"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
              		...
              		<c:if test="${stumanager.mgsex==null}">
              		<input name="mgsex" id="mgsex" value="男" title="男" checked="" type="radio">
              		<input name="mgsex" value="女" title="女"  type="radio">
              		</c:if>
              </div>

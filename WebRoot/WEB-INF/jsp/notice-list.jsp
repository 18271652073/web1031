  ...
  <body>
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <a href="<%=basePath%>NoticeController/addNoticePage.action?pageNum=${pageNum}"><button class="layui-btn" ><i class="layui-icon"></i>添加</button></a>
      ...
      <table class="layui-table">
        ...
        <tbody>
       			<c:forEach items="${noticeList}" var="nl" varStatus="num">
					<tr>
						<td>
						  <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='${nl.nid}'><i class="layui-icon">&#xe605;</i></div>
			            </td>
						...
						<c:if test="${user.mgpower==3 }">
							 <a title="编辑" href="<%=basePath%>NoticeController/editNoticePage.action?nid=${nl.nid }&pageNum=${pageNum}">
						...
						<c:if test="${user.mgpower<=2 }">
			              ...
			              <a title="删除" onclick="delOne(${nl.nid})" href="javascript:;">
			                <i class="layui-icon">&#xe640;</i>
			              </a>
			            </td>
					</tr>
  ...
  //分页
	$("#page").paging({
		...
		callback: function(num) {
			location.href="<%=basePath%>NoticeController/findNotice.action?pageNum="+num;
		}
	});
	  function delAll(argument) {
        ...
        location.href="<%=basePath%>NoticeController/delectNotice.action?data="+data+"&pageNum="+${pageNum};
      }
